...
submit_diagnostic() {
  ...
  local job_export="ALL,DISSERTATION_REPO_DIR=${repo_dir},BRMS_FIT_PATH=${fit_path},BRMS_DIAGNOSTIC_OUTPUT_DIR=${diagnostic_output_dir},EXPECTED_GIT_COMMIT=${repo_commit}"
  local submitted
...
rq3_ffd_diagnostic_id="$(submit_diagnostic \
  rq3_ffd_diagnostics "${rq3_cv_id}" \
  "${data_dir}/brm_cache/rq3coef_v3_total_FFD.rds")"
rq3_gd_diagnostic_id="$(submit_diagnostic \
  rq3_gd_diagnostics "${rq3_cv_id}" \
  "${data_dir}/brm_cache/rq3coef_v3_total_GD.rds")"
...
rq3_gd_excl_diagnostic_id="$(submit_diagnostic \
  rq3_gd_excl_diagnostics "${rq3_cv_excl_id}" \
  "${data_dir}/brm_cache/rq3coef_v3_total_GD_exclude_contrastive.rds")"
rq3_go_past_excl_diagnostic_id="$(submit_diagnostic \
  rq3_go_past_excl_diagnostics "${rq3_cv_excl_id}" \
  "${data_dir}/brm_cache/rq3coef_v3_total_Go-past_exclude_contrastive.rds")"
