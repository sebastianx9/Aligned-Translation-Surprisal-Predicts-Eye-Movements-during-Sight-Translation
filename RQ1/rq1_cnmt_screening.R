...
script_path <- if (length(script_arg)) {
  ...
  normalizePath("RQ1/rq1_cnmt_screening.R", mustWork = TRUE)
}
...
copy_scan <- Sys.getenv("DISSERTATION_COPY_SCAN", unset =
  "/Users/sebastianx/Dissertation RQ1/copy_failures_full_scan.csv")
